...
// In the create method, update the barcode handling
const productData: Prisma.ProductCreateInput = {
  name: createProductDto.name,
  category: { connect: { id: createProductDto.categoryId } },
  branch: { connect: { id: createProductDto.branchId } },
...
// Only set barcode if provided, otherwise it will be generated by the database
if (createProductDto.barcode) {
  productData.barcode = createProductDto.barcode;
} else {
  // Generate a barcode if none provided
  productData.barcode = await this.generateUniqueBarcode(prismaClient);
}
...
async update(
  ...
  const updateData: Prisma.ProductUpdateInput = {
    ...
    branch: updateProductDto.branchId ? { connect: { id: updateProductDto.branchId } } : undefined,
    ...
    // Only update barcode if explicitly provided in the DTO
